...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    markup.add(bat_a)
    await bot.copy_message(from_chat_id=content, chat_id= message.chat.id, message_id=25)
    await bot.copy_message(from_chat_id=content, chat_id=message.chat.id, message_id=26,reply_markup=markup)
